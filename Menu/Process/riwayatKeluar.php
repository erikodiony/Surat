...
$per_hal=5;
$jumlah_record=mysql_query("SELECT COUNT(*) FROM s_keluar");
...
<head>
<title>&nbsp ./Aplikasi&nbspSurat&nbsp Dinsosnaker &nbsp- &nbspRiwayat &nbsp Surat&nbsp Keluar&nbsp|</title>
<meta charset="utf-8">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-flag"></span> Riwayat Surat Keluar</h4>
		<h5>Anda Dapat Melihat Data Surat Keluar lebih detail !</h5>
      </div>
	   ...
	   ?>
		...
		<table class="table table-striped"> 
			  <tr>
				...
				<td><div align="center"><strong><span class="glyphicon glyphicon-calendar"></span>&nbsp Tgl. Dikirim</strong></div></td> 
				<td><div align="center"><strong><span class="glyphicon glyphicon-user"></span>&nbsp Surat Dikirim Ke</strong></div></td> 
		  ...
		  <?php 
			  $tampil="SELECT * FROM `s_keluar` ORDER BY no_agenda DESC limit $start, $per_hal;"; 
			  $qryTampil=mysql_query($tampil); 
			  while ($dataTampil=mysql_fetch_array($qryTampil)) { 
		  ?> 
			   <tr> 
				<td><center><?php echo $dataTampil['no_agenda'] ; ?></center></td> 
				<td><center><?php echo $dataTampil['tgl_suratk']; ?></center></td> 
				<td><center><?php echo $dataTampil['srt_ke']; ?></center></td> 
