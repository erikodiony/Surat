	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title"><span class="glyphicon glyphicon-envelope"></span>&nbsp Tampil Surat Masuk</h4>	
			...
			<div class="modal-body" >
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"><b>No. Agenda : <?php echo $dataTampil['no_agenda'] ; ?> (Surat Masuk)</b></h3>
					</div>
					...
					<div class="panel-body">
						...
						<label class="col-md-4">Isi Disposisi</label>
						<label class="col-md-8 col-md-offset-0">: <?php echo $dataTampil['isi_disposisi'] ; ?></label>
						<label class="col-md-4">Tanggal Diterima</label>
						<label class="col-md-8 col-md-offset-0">: <?php echo $dataTampil['tgl_terima'] ; ?></label>
						...
						<label class="col-md-8 col-md-offset-0">: <?php echo $dataTampil['srt_tgl'] ; ?></label>
						<label class="col-md-4">Surat Dari</label>
						<label class="col-md-8 col-md-offset-0">: <?php echo $dataTampil['srt_dari'] ; ?></label>
						...
						<div class="col-md-4">
						<button type="button" class="btn btn-lg btn-success" onclick="location.href='cetak.php?no_urutm=<?php echo $dataTampil['no_urut'] ; ?>'"><span class="glyphicon glyphicon-print"></span> Cetak</button>
						</div>
						<div class="col-md-4">
						<button class="btn btn-lg btn-warning" onclick="location.href='editSuratMasuk.php?no_urutm=<?php echo $dataTampil['no_urut'] ; ?>'"><span class="glyphicon glyphicon-edit"></span> Edit</button>
						</div>
						<div class="col-md-4">
						<button class="btn btn-lg btn-danger" onclick="location.href='cekHapusSuratMasuk.php?no_urutm=<?php echo $dataTampil['no_urut'] ; ?>'"><span class="glyphicon glyphicon-trash"></span> Hapus</button>
						</div>
