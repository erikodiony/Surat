...
<html>
<head>
  <title>&nbsp ./Aplikasi&nbspSurat&nbsp Dinsosnaker &nbsp- &nbspUser &nbsp|</title>
<meta charset="utf-8">
...
<div class="row">
	...
	<div class="col-md-9">
		...
		<div class="col-md-6">
			<h4 class="text-right"><b><a href="user.php" style="text-decoration:none"><span class="glyphicon glyphicon-refresh"></span> Segarkan</a></b></h4>
		</div>
		<div class="col-md-12">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Kata Kunci</label>
											<div class="col-md-6 inputGroupContainer">
										        ...
										        <input readonly type="text" onfocus="cekTgl()" name="cari_tgl" id="cari_tgl" class="form-control" placeholder="Masukkan Tanggal.." >
									...
									<div class="form-group">
										<label class="col-md-4 control-label">*Tanggal Diterima</label>
											<div class="col-md-4 inputGroupContainer">
												<div class="input-group date form_date" data-date-format="dd MM yyyy" data-link-format="yyyy-mm-dd">
										        <input readonly type="text" onfocus="cekTgl()" name="tgl_msk" id="tgl_msk" class="form-control" placeholder="Tanggal Diterima.." >
												<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
												<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										        </div>
											</div>	
									...
									<div class="form-group">
										<label class="col-md-2 control-label">*No. Surat</label>
											...
											<div class="col-md-4 inputGroupContainer">
										        ...
										        <input readonly onfocus="cekTgl()" type="text" name="tgl_suratm" id="tgl_suratm" class="form-control" placeholder="Tanggal Surat.." >
												<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
												<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
										        </div>
											</div>	
